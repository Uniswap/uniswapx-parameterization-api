...
import { FadesRepository, V2FadesRepository } from '../../lib/repositories';

describe('FadesRepository Integration Tests', () => {
  let fadesRepository: FadesRepository;
  ...
  beforeAll(() => {
    ...
    fadesRepository = new FadesRepository(client, configs);
  ...
  describe('createFadesView', () => {
    ...
    it('should successfully query V2 fades view', async () => {
