...
import { transformFillLogEvent, transformQuoteRequestLogEvent } from './transformations';
...
export const quoteRequestProcessor = async (event, context) => handler(event, context, transformQuoteRequestLogEvent);
